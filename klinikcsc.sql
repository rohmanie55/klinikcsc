...
--
-- Host: 127.0.0.1:3305
-- Generation Time: 19 Nov 2019 pada 12.31
-- Versi Server: 5.6.16
-- PHP Version: 5.5.11
...
('H0005', 'Bio Skin Car', 10000, 15000, 25, 'Skin car', ''),
('H0009', 'Cream Jerawat Anisa Dark Spot', 55000, 85000, 8, 'untuk jerawat', ''),
...
('H0011', 'ACD', 100000, 150000, 14, 'CREAM ACD', 'assets/img/IMG-20180814-WA0004.jpg'),
('H0013', 'fxhgsda', 12222, 22222, 12, 'dsdasfasf', 'assets/img/new logo.jpg');
...
('0000019', 'RM0015', '2019-02-17', '2019-02-17', '12:10:00', 'jhkhhjhjm', 'T005', 1, 'P009');
...
INSERT INTO `penjualan` (`no_penjualan`, `tgl_penjualan`, `pelanggan`, `keterangan`, `uang_bayar`, `kd_petugas`, `idtransaksi`) VALUES
('JL00001', '2019-02-17', 'Pasien', '', 200000, 'P009', 0),
('JL00002', '2019-02-17', 'Pasien', '', 50000, 'P009', 0),
('JL00003', '2019-10-31', 'Pasien', 'test', 200000, 'P001', 0),
('JL00004', '2019-11-02', '', 'Penjualan $ Perawatan Pasien', 100000, 'P001', 0),
('JL00005', '2019-11-03', 'Muzukashi', 'Perawatan Pasien', 15000, 'P001', 8);
...
('JL00003', 'H0005', 10000, 15000, 2),
('JL00003', 'H0011', 100000, 150000, 1),
('JL00004', 'H0005', 10000, 15000, 2);
...
INSERT INTO `rawat` (`no_rawat`, `tgl_rawat`, `nomor_rm`, `hasil_diagnosa`, `uang_bayar`, `kd_petugas`, `idtransaksi`) VALUES
('RP00001', '2019-01-19', 'RM0014', 'UHUHHUYH', 100000, 'P008', 0),
('RP00002', '2019-01-19', 'RM0013', 'GBKKKK', 200000, 'P001', 0),
('RP00003', '2019-01-19', 'RM0013', 'hgjhjh', 5000000, 'P001', 0),
('RP00004', '2019-02-17', 'RM0015', 'hgfffghvfhgvhtg', 400000, 'P009', 0),
('RP00005', '2019-11-02', 'RM0013', '', 100000, 'P001', 0);
...
(30, '2019-11-02', 'RP00005', 'T015', 70000, 'D002', 10);
...
INSERT INTO `transaksi` (`id`, `harga`, `bayar`, `timestamp`, `idpetugas`) VALUES
(8, 15000, 170000, '2019-11-03 02:28:53', 'P001');
