...
?>
	...
	?>
      <tr>
        ...
        <td width="45" align="center"><a href="rawat_nota.php?trx=<?php echo $myData['idtransaksi']; ?>&nomorRawat=<?php echo $Kode; ?>" target="_blank" class="btn btn-success"><i class="fa fa-credit-card"></i></a></td>
